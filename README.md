...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-flexplot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13535&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-flexplot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-flexplot` can be installed with:

```
conda install r-flexplot
```

It is possible to list all of the versions of `r-flexplot` available on your platform with:
